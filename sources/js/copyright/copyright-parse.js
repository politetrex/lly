...
document.addEventListener('DOMContentLoaded', function() {
    if (copyright!="HIDDEN"){
        ...
        const statusURL = "https://stats.uptimerobot.com/7Yg6kuHOV3";
        ...
        const greenDotSVG = `<svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
            <circle cx="5" cy="5" r="5" fill="#10b981" stroke="#047857" stroke-width="0"/>
            </svg>`;
        ...
        copyrightText += `. All rights reserved. <a href="${statusURL}" target="_blank" rel="noopener noreferrer" style="color: green; text-decoration: none;">${greenDotSVG}Status </a>`;
